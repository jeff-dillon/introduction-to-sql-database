...
CREATE TABLE person_address(
    ...
    FOREIGN KEY(person_address_address_id) REFERENCES address (address_id),
    FOREIGN KEY(person_address_person_id) REFERENCES person (person_id));

CREATE TABLE phone_number(
    phone_number_id INTEGER PRIMARY KEY,
    phone_number_person_id INTEGER NOT  NULL,
    phone_number VARCHAR(55) NOT NULL,
    FOREIGN KEY(phone_number_person_id) REFERENCES person (person_id));
